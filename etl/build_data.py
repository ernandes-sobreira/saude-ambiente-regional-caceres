...
GRUPO_META = {
    ...
    'LEISHMANIOSE_MALARIA': dict(label='Malária e Leishmanioses', cat='Vetorial / Climática', cor='#c0392b',
        amb=['precip','temp_media','floresta'],
        desc='Protozooses transmitidas por vetores (CID B50-B64). MALÁRIA (B50-B54): causada por Plasmodium, transmitida pelo mosquito Anopheles, ligada a áreas úmidas/ribeirinhas e garimpo. LEISHMANIOSES (B55): causadas por Leishmania, transmitidas pelo flebotomíneo (mosquito-palha), associadas a desmatamento e ambiente rural/florestal. ⚠️ A fonte agrega ambas sob B50-B64; separá-las exige reextração por CID específico.'),
